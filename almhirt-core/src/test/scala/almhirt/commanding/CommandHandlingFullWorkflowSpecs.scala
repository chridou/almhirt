...
//
//class CommandHandlingFullWorkflowSpecs
//  extends TestKit(ActorSystem("CommandHandlingFullWorkflowSpecsSystem", TestConfigs.default))
//  with FunSpec
//  with ShouldMatchers
...
//          val theCommands =
//            List[TestArCommand](
//              TestArCommanding.CreateTestAr(DomainCommandHeader(aggRef), "a").track("track me"),
//              TestArCommanding.ChangeB(DomainCommandHeader(aggRef), Some("B")),
//              TestArCommanding.ChangeA(DomainCommandHeader(aggRef), "s"))
//          val groupedCommands = CommandGrouping.groupCommands("mygroup", theCommands)
//          groupedCommands.foreach(executor ! _)
...
//            List[TestArCommand](
//              TestArCommanding.CreateTestAr(DomainCommandHeader(aggRef), "a").track("track me"),
//              TestArCommanding.ChangeB(DomainCommandHeader(aggRef), Some("")),
//              TestArCommanding.ChangeA(DomainCommandHeader(aggRef), "s"))
//          val groupedCommands = CommandGrouping.groupCommands("mygroup", theCommands)
//          groupedCommands.foreach(executor ! _)
//          val res = probe.receiveWhile(defaultWaitDuration, defaultWaitDuration, 9) {
