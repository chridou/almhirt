...
final case class GetDomainEventByIdQry(eventId: UUID, correlationId: Option[UUID] = None) extends DomainEventLogCmd
...
final case class GetDomainEventsToQry(aggId: UUID, to: Long, chunkSize: Option[Int] = None, correlationId: Option[UUID] = None) extends DomainEventLogCmd
