...
class MessageGroupingDecomposer extends Decomposer[MessageGrouping] {
  ...
  def decompose[TChannel <: RiftChannelDescriptor, TDimension <: RiftTypedDimension[_]](what: MessageGrouping)(implicit into: Dematerializer[TChannel, TDimension]): AlmValidation[Dematerializer[TChannel, TDimension]] = {
    into
...
class MessageHeaderDecomposer extends Decomposer[MessageHeader] {
  ...
  def decompose[TChannel <: RiftChannelDescriptor, TDimension <: RiftTypedDimension[_]](what: MessageHeader)(implicit into: Dematerializer[TChannel, TDimension]): AlmValidation[Dematerializer[TChannel, TDimension]] = {
    into
      .addTypeDescriptor(this.typeDescriptor)
...
class MessageDecomposer extends Decomposer[Message[AnyRef]] {
  ...
  def decompose[TChannel <: RiftChannelDescriptor, TDimension <: RiftTypedDimension[_]](what: Message[AnyRef])(implicit into: Dematerializer[TChannel, TDimension]): AlmValidation[Dematerializer[TChannel, TDimension]] = {
    into
      .addTypeDescriptor(this.typeDescriptor)
