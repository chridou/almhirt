...
object ActorMessages {
  final case class CreateChildActor(factory: ComponentFactory, returnActorRef: Boolean)
...
object CreateChildActorHelper {
  ...
  def createChildActor(parent: ActorRef, factory: ComponentFactory)(maxDur: FiniteDuration)(implicit execCtx: ExecutionContext): AlmFuture[ActorRef] = {
    parent.ask(ActorMessages.CreateChildActor(factory, true))(maxDur).successfulAlmFuture[ActorMessages.CreateChildActorRsp].mapV {
