...
package object components {
  ...
  //  def tryGetDecomposer[T <: AnyRef](implicit m: ClassTag[T]): Option[Decomposer[T]] = tryGetDecomposer(m.runtimeClass)
  ...
  //    }
  //
  //  def getDecomposer[T <: AnyRef](implicit m: ClassTag[T]): AlmValidation[Decomposer[T]] =
