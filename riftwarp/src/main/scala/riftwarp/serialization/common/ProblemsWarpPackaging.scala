...
object ProblemTypes {
  ...
  val NoTimelyResponseFromServiceProblemPackaging = createDefaultPackaging[almhirt.problem.problemtypes.NoTimelyResponseFromServiceProblem.type](almhirt.problem.problemtypes.NoTimelyResponseFromServiceProblem)
  ...
  val VersionConflictProblemPackaging = createDefaultPackaging[almhirt.problem.problemtypes.VersionConflictProblem.type](almhirt.problem.problemtypes.VersionConflictProblem)
  ...
  val TooMuchDataProblemPackaging = createDefaultPackaging[almhirt.problem.problemtypes.TooMuchDataProblem.type](almhirt.problem.problemtypes.TooMuchDataProblem)
  ...
  def registerPackers(to: WarpPackers) {
    ...
    to.addTyped(NoTimelyResponseFromServiceProblemPackaging)
    ...
    to.addTyped(VersionConflictProblemPackaging)
    ...
    to.addTyped(TooMuchDataProblemPackaging)
