...
object Serializers {
  ...
  def createForStringsWithBlobs[TIn <: AnyRef, TOut <: AnyRef](riftWarp: RiftWarp, blobStorage: BlobStorage { type TBlobId = JUUID }, minBlobSize: Int)(implicit support: HasExecutionContext with CanCreateUuid, tag: ClassTag[TOut]): StringSerializing[TIn, TOut] = {
