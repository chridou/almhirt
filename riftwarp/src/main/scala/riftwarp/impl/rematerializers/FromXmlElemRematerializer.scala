...
//      Success(((x: Elem) => parseBooleanAlm(x.text).withIdentifierOnFailure(key)).asInstanceOf[Elem => AlmValidation[A]])
//    else if (mA.runtimeClass.isAssignableFrom(classOf[Byte]))
//      Success(((x: Elem) => parseByteAlm(x.text).withIdentifierOnFailure(key)).asInstanceOf[Elem => AlmValidation[A]])
//    else if (mA.runtimeClass.isAssignableFrom(classOf[Int]))
//      Success(((x: Elem) => parseIntAlm(x.text).withIdentifierOnFailure(key)).asInstanceOf[Elem => AlmValidation[A]])
//    else if (mA.runtimeClass.isAssignableFrom(classOf[Long]))
//      Success(((x: Elem) => parseLongAlm(x.text).withIdentifierOnFailure(key)).asInstanceOf[Elem => AlmValidation[A]])
//    else if (mA.runtimeClass.isAssignableFrom(classOf[BigInt]))
//      Success(((x: Elem) => parseBigIntAlm(x.text).withIdentifierOnFailure(key)).asInstanceOf[Elem => AlmValidation[A]])
//    else if (mA.runtimeClass.isAssignableFrom(classOf[Float]))
//      Success(((x: Elem) => parseFloatAlm(x.text).withIdentifierOnFailure(key)).asInstanceOf[Elem => AlmValidation[A]])
//    else if (mA.runtimeClass.isAssignableFrom(classOf[Double]))
//      Success(((x: Elem) => parseDoubleAlm(x.text).withIdentifierOnFailure(key)).asInstanceOf[Elem => AlmValidation[A]])
//    else if (mA.runtimeClass.isAssignableFrom(classOf[BigDecimal]))
//      Success(((x: Elem) => parseDecimalAlm(x.text).withIdentifierOnFailure(key)).asInstanceOf[Elem => AlmValidation[A]])
//    else if (mA.runtimeClass.isAssignableFrom(classOf[org.joda.time.DateTime]))
//      Success(((x: Elem) => parseDateTimeAlm(x.text).withIdentifierOnFailure(key)).asInstanceOf[Elem => AlmValidation[A]])
//    else if (mA.runtimeClass.isAssignableFrom(classOf[_root_.java.util.UUID]))
//      Success(((x: Elem) => parseUuidAlm(x.text).withIdentifierOnFailure(key)).asInstanceOf[Elem => AlmValidation[A]])
//    else if (mA.runtimeClass.isAssignableFrom(classOf[_root_.java.net.URI]))
//      Success(((x: Elem) => parseUriAlm(x.text).withIdentifierOnFailure(key)).asInstanceOf[Elem => AlmValidation[A]])
//    else
...
//
//  def tryGetBoolean(ident: String) = tryGetElemThenMapForPrimitive(ident, txt => parseBooleanAlm(txt).withIdentifierOnFailure(ident))
//
//  def tryGetByte(ident: String) = tryGetElemThenMapForPrimitive(ident, txt => parseByteAlm(txt).withIdentifierOnFailure(ident))
//  def tryGetInt(ident: String) = tryGetElemThenMapForPrimitive(ident, txt => parseIntAlm(txt).withIdentifierOnFailure(ident))
//  def tryGetLong(ident: String) = tryGetElemThenMapForPrimitive(ident, txt => parseLongAlm(txt).withIdentifierOnFailure(ident))
//  def tryGetBigInt(ident: String) = tryGetElemThenMapForPrimitive(ident, txt => parseBigIntAlm(txt).withIdentifierOnFailure(ident))
//
//  def tryGetFloat(ident: String) = tryGetElemThenMapForPrimitive(ident, txt => parseFloatAlm(txt).withIdentifierOnFailure(ident))
//  def tryGetDouble(ident: String) = tryGetElemThenMapForPrimitive(ident, txt => parseDoubleAlm(txt).withIdentifierOnFailure(ident))
...
//
//  def tryGetUri(ident: String) = tryGetElemThenMapForPrimitive(ident, txt => parseUriAlm(txt).withIdentifierOnFailure(ident))
//
//  def tryGetUuid(ident: String) = tryGetElemThenMapForPrimitive(ident, txt => parseUuidAlm(txt).withIdentifierOnFailure(ident))
//
