...
//        decomposer.decomposeRaw(toDecompose)(spawnNew(idx :: ident :: path)).map(_.dematerialize.manifestation)
//      case None =>
...
//            decomposer.decomposeRaw(toDecomposeAsAnyRef)(spawnNew(idx :: ident :: path)).map(_.dematerialize.manifestation))
//        case x =>
