...
object RiftWarpUtilityFuns {
  def addRiftWarpRegistrations(riftWarp: riftwarp.RiftWarp) {
    ...
    riftWarp.barracks.addDecomposer(PerformedDomainActionDecomposer)
    ...
    riftWarp.barracks.addDecomposer(OperationStateEventDecomposer)
    ...
    riftWarp.barracks.addRecomposer(PerformedDomainActionRecomposer)
    ...
    riftWarp.barracks.addRecomposer(OperationStateEventRecomposer)
  }
}