...
trait HttpAggregateRootEventLogQueryEndpointFactory extends Directives { me: Actor with AlmHttpEndpoint with HasAlmhirtContext ⇒
  ...
  def createAggregateRootEventLogQueryEndpoint(params: HttpAggregateRootEventLogQueryEndpointFactory.HttpAggregateRootEventLogQueryEndpointParams): RequestContext ⇒ Unit = {
