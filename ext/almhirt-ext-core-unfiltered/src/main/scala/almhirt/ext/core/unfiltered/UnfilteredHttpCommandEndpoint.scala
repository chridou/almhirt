...
class UnfilteredHttpCommandEndpoint(httpCommandEndpoint: HttpCommandEndpoint[HttpRequest[Any]], responder: ResponseConsumer[unfiltered.Async.Responder[Any]], problemConsumer: Consumer[Problem], hec: HasExecutionContext) {
