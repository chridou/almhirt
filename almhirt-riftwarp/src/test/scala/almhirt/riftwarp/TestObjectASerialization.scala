...
class PrimitiveTypesDecomposer extends Decomposer[PrimitiveTypes] {
  ...
  def decompose[TChannel <: RiftChannelDescriptor, TDimension <: RiftTypedDimension[_]](what: PrimitiveTypes)(implicit into: Dematerializer[TChannel, TDimension]): AlmValidation[Dematerializer[TChannel, TDimension]] = {
    into.addTypeDescriptor(typeDescriptor)
...
class PrimitiveListMAsDecomposer extends Decomposer[PrimitiveListMAs] {
  ...
  def decompose[TChannel <: RiftChannelDescriptor, TDimension <: RiftTypedDimension[_]](what: PrimitiveListMAs)(implicit into: Dematerializer[TChannel, TDimension]): AlmValidation[Dematerializer[TChannel, TDimension]] = {
    into.addTypeDescriptor(typeDescriptor)
...
class PrimitiveVectorMAsDecomposer extends Decomposer[PrimitiveVectorMAs] {
  ...
  def decompose[TChannel <: RiftChannelDescriptor, TDimension <: RiftTypedDimension[_]](what: PrimitiveVectorMAs)(implicit into: Dematerializer[TChannel, TDimension]): AlmValidation[Dematerializer[TChannel, TDimension]] = {
    into.addTypeDescriptor(typeDescriptor)
...
class PrimitiveSetMAsDecomposer extends Decomposer[PrimitiveSetMAs] {
  ...
  def decompose[TChannel <: RiftChannelDescriptor, TDimension <: RiftTypedDimension[_]](what: PrimitiveSetMAs)(implicit into: Dematerializer[TChannel, TDimension]): AlmValidation[Dematerializer[TChannel, TDimension]] = {
    into.addTypeDescriptor(typeDescriptor)
...
class PrimitiveIterableMAsDecomposer extends Decomposer[PrimitiveIterableMAs] {
  ...
  def decompose[TChannel <: RiftChannelDescriptor, TDimension <: RiftTypedDimension[_]](what: PrimitiveIterableMAs)(implicit into: Dematerializer[TChannel, TDimension]): AlmValidation[Dematerializer[TChannel, TDimension]] = {
    into.addTypeDescriptor(typeDescriptor)
